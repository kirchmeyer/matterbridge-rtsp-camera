...
export class Go2RTCClient {
    ...
    private readonly directSourceIds = new Set<string>();
    ...
    registerDirectSource(id: string, name: string, rtspUrl: string): void {
        this.sources.set(id, { name, rtspUrl });
